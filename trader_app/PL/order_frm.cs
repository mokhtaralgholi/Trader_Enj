...
{
    public partial class order_frm :add_form
    {
        ...
        private void txt_edit_user_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txt_in_date_TextChanged(object sender, EventArgs e)
        {

        }

        private void txt_by_user_TextChanged(object sender, EventArgs e)
        {

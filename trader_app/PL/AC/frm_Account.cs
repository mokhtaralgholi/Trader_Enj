...
namespace trader_app.PL.AC
{
    ...
    {
        // These controls are declared in the designer.
        // (Any commented-out declarations were left intact for reference.)
        // TextBox txt_id = new TextBox();
        // TextBox txt_A_N = new TextBox();
        // TextBox txt_E_N = new TextBox();
        // TextBox txt_Note = new TextBox();
        ...
        // ComboBox cbx_Account_group = new ComboBox();
        // ComboBox cbx_Account_type = new ComboBox();
        // ComboBox cbx_Account_Calss = new ComboBox();
        // ComboBox cbx_parent = new ComboBox();
        // ComboBox Cbx_Account_status = new ComboBox();
        // ComboBox cbx_Rapport = new ComboBox();
        // DataGridView dgv_Account_curr = new DataGridView();
        ...
        // Button btn_Account_request = new Button();
        ...
        private void PopulateTreeView(int parentId, TreeNode parentNode)
        {
            ...
            if (parentId == 0)
            {
                foreach (DataRow dr in dt.Select("[Account_Parent_ID] is NULL"))
                {
                    ...
                    {
                        Text = dr["Account_ID"].ToString() + " - " + dr["A_N"].ToString(),
                        Name = dr["Account_ID"].ToString(),
